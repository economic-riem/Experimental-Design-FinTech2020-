...
if __name__ == '__main__':
    ...
    train_tag = pd.read_csv(r'C:\Users\ljs11\Desktop\Fintect\FinTech2020-master(大佬方案)\Final_code\data\RawData\训练数据集_tag.csv')
    # test_tag = pd.read_csv(os.path.join(RAW_DATA_PATH, '评分数据集_tag_b.csv'))
    test_tag = pd.read_csv(r'C:\Users\ljs11\Desktop\Fintect\FinTech2020-master(大佬方案)\Final_code\data\RawData\评分数据集_tag_b.csv')

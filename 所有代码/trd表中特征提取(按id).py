...
fea['per_day_trd_times'] = fea['count'] / fea['date']
fea['per_day_trd_amt'] = fea['cny_trx_amt'] / fea['date']
fea['per_count_trd_amt'] = fea['cny_trx_amt'] / fea['count']
...
for col in cols:
    ...
    for xcol in tmp_count.columns[1:]:
        fea[col+'_per_day_times_'+xcol.split('_')[-1]] = fea[xcol] / fea['date']

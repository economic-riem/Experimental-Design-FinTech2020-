...
if __name__ == '__main__':
    ...
    train_trd = pd.read_csv(r'C:\Users\ljs11\Desktop\Fintect\FinTech2020-master(大佬方案)\Final_code\data\RawData\训练数据集_trd.csv')
    ...
    test_trd = pd.read_csv(r'C:\Users\ljs11\Desktop\Fintect\FinTech2020-master(大佬方案)\Final_code\data\RawData\评分数据集_trd_b.csv')
